...
CUDA_VISIBLE_DEVICES=0,1 python src/tasks/vqa.py \
    ...
    --RESUME 1 --path_checkpoint '../../user_data/model_data/n_query_BEST.pth' \
    --batchSize 200 --optim bert --lr 6e-10 --epochs 24 --max_area_boxes 20 --ROI_select 0 \
    --nprob 1 --tqdm --output $output ${@:3}