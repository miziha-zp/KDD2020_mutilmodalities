...
CUDA_VISIBLE_DEVICES=0,1 python src/tasks/vqa.py \
    ...
    --RESUME 1 --path_checkpoint '../../user_data/lxmert_model/checkpoint/lxr_best.pth' \
    --batchSize 200 --optim bert --lr 6e-5 --epochs 9 --max_area_boxes 5 --ROI_select 0 \
    --nprob 0 --tqdm --output $output ${@:3}
