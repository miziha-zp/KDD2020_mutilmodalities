...
def load_lxmert_qa(path, model, label2ans=None):
    """
    ...
    # print()
    answer_state_dict['logit_fc.3.weight'] = answer_state_dict['logit_fc.3.weight'].resize_(1, 1536)
    answer_state_dict['logit_fc.3.bias'] = answer_state_dict['logit_fc.3.bias'].resize_(1)
